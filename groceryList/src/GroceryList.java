...
public class GroceryList {
    ...
    GroceryItemOrder product1 = new GroceryItemOrder("Æble", 10,1);
    GroceryItemOrder product2 = new GroceryItemOrder("Brød", 10,2);
    GroceryItemOrder product3 = new GroceryItemOrder("Æg",10,3);
    GroceryItemOrder product4 = new GroceryItemOrder("Æg",10,3);
    GroceryItemOrder product5 = new GroceryItemOrder("Æg",10,3);
    GroceryItemOrder product6 = new GroceryItemOrder("Æg",10,3);
    GroceryItemOrder product7 = new GroceryItemOrder("Æg",10,3);
